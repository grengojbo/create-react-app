...
var InterpolateHtmlPlugin = require('react-dev-utils-custom/InterpolateHtmlPlugin');
...
```js
var path = require('path');
var ModuleScopePlugin = require('react-dev-utils-custom/ModuleScopePlugin');
...
```js
var path = require('path');
var WatchMissingNodeModulesPlugin = require('react-dev-utils-custom/WatchMissingNodeModulesPlugin');
...
```js
var path = require('path');
var checkRequiredFiles = require('react-dev-utils-custom/checkRequiredFiles');
...
```js
var clearConsole = require('react-dev-utils-custom/clearConsole');
...
```js
const eslintFormatter = require('react-dev-utils-custom/eslintFormatter');
...
} = require('react-dev-utils-custom/FileSizeReporter');
...
var formatWebpackMessages = require('react-dev-utils-custom/formatWebpackMessages');
...
```
  const printBuildError = require('react-dev-utils-custom/printBuildError')
  try {
    build()
  } catch(e) {
...
```js
var getProcessForPort = require('react-dev-utils-custom/getProcessForPort');
...
```js
var path = require('path');
var openBrowser = require('react-dev-utils-custom/openBrowser');
...
module.exports = {
  ...
  entry: [
    ...
    'react-dev-utils-custom/webpackHotDevClient',
    'src/index'
  ],
  // ...
}
